...
const signaturePadFn = memo((props = {}) => {
  return Object.fromEntries(signaturePadSlotFns.map(([slotName, slotFn]) => [slotName, slotFn.recipeFn(props)]))
})

const signaturePadVariantKeys = []
const getVariantProps = (variants) => ({ ...signaturePadDefaultVariants, ...compact(variants) })
